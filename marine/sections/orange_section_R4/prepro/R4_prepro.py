...
#########################################
#PREPROCESSING SCRIPT FOR ORANGE BASIN SECTION R4
...
def scale_surface(x_imported, y_imported):
    ...
    section_max_x = 1378800 #true length of the section for scaling
    x_new = -(x_imported / max(x_imported)) * section_max_x + section_max_x
    y_new = y_imported + abs(min(y_imported))
    y_new = (y_new / 51.303) * 7191  #rescale sections using measurements from vector editor
    y_new -= max(y_new)
...
folder = '/users/cs00048/marine/sections/orange_section_R4/prepro/strat_data_lines/'
filenames = [folder + '5_A22+RC1214_edit_TD_CS_top_of_synrift_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U1_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U2_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U3_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U4_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U5_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U6_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U7_only.svg', 
             folder + '5_A22+RC1214_edit_TD_CS_top_of_U8_only.svg', ]
...
np.save('/scratch/cs00048/marine/sections/orange_section_R4/prepro/bedrock_elev_array.npy', br_elev_array)
...
#save out array as npy binary
np.save('/scratch/cs00048/marine/sections/orange_section_R4/prepro/qs_array.npy', qs_array)
...
np.save('/scratch/cs00048/marine/sections/orange_section_R4/prepro/all_surfaces.npy', all_surfaces)
