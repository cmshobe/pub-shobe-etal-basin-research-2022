...
#########################################
#PREPROCESSING SCRIPT FOR ORANGE BASIN SECTION R1
...
def scale_surface(x_imported, y_imported):
    ...
    section_max_x = 1916653 #true length of the section for scaling
    x_new = -(x_imported / max(x_imported)) * section_max_x + section_max_x
    y_new = y_imported + abs(min(y_imported))
    y_new = (y_new / 46.379) * 6503 #rescale sections using measurements from vector editor
    y_new -= max(y_new)
...
folder = '/users/cs00048/marine/sections/orange_section_R1/prepro/strat_data_lines_EDIT/'
filenames = [folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_synrift_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U1_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U2_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U3_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U4_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U5_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U6_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U7_only_EDIT.svg', 
             folder + '8_V2204_FM104-AM56_sism-Broucke_edit_TD_CS_top_of_U8_only_EDIT.svg', ]
...
np.save('/scratch/cs00048/marine/sections/orange_section_R1/prepro/bedrock_elev_array.npy', br_elev_array)
...
#save out array as npy binary
np.save('/scratch/cs00048/marine/sections/orange_section_R1/prepro/qs_array.npy', qs_array)
...
np.save('/scratch/cs00048/marine/sections/orange_section_R1/prepro/all_surfaces.npy', all_surfaces)
